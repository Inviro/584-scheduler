<!doctype html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class={{$dark_mode ? "bg-primary" : "bg-white"}}>
  <head>
    <meta charset="utf-8">
  ...
  <body>
      <div id="app">
        ...
        <main id="main-content" class="py-4 {{$dark_mode ? "bg-secondary" : ""}}">
          @yield('content')
        </main>
    </div>
    <footer id="footer" class="{{ $dark_mode ? "text-light bg-dark" : "bg-white" }}">
      <br>
